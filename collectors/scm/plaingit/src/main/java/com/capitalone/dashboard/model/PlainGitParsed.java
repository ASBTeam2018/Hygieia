...
public class PlainGitParsed {
    ...
    // plaingit 
    public static String localRepoPath = "/repo";
    public static String localRepoGitConfig = "/repo/.git";
    public static String remoteRepoURI = "git@windtools.cn:/data/repos/evi.git";// windows本地获取EVI
    public static String localCodeDir = "/platplat";

    public PlainGitParsed(String url) throws MalformedURLException, HygieiaException {
        this.url = url;
        parse();
    }
